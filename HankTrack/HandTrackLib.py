...
'''------------------------------------------------------------------------------------------------------------------'''
# Load caliberation data for coordinate mapping
...
coordinateText = ax.text(0, 0, 600, '')
...
def animUpdate(frame_i, palmPoint, digit1DistalLine, digit2DistalLine, digit3DistalLine, digit4DistalLine,
    ...
    if(trackres == 1):
        ...
        coordinateText.set_text('(%.1f, %.1f, %.1f)' % (data1f[DIGIT2_DISTAL[1], 0], data1f[DIGIT2_DISTAL[1], 1],
                                              data1f[DIGIT2_DISTAL[1], 2]))
